...
package org.gault.messages.databases
...
import org.gault.messages.helpers.Converters
import org.gault.messages.interfaces.*
import org.gault.messages.models.*
...
@Database(
    ...
    version = 11 // Incremented to accommodate Gault is_p2p field
)
...
abstract class MessagesDatabase : RoomDatabase() {
    ...
    companion object {
                    ...
                    if (db == null) {
                        db = Room.databaseBuilder(
                            ...
                            .addMigrations(
                                ...
                                MIGRATION_10_11 // Registered Gault-Aware Migration
                            )
                            .build()
                    }
                }
        ...
        private val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.apply {
                    ...
                    execSQL("INSERT OR IGNORE INTO conversations_new (thread_id, snippet, date, read, title, photo_uri, is_group_conversation, phone_number) SELECT thread_id, snippet, date, read, title, photo_uri, is_group_conversation, phone_number FROM conversations")
        ...
        private val MIGRATION_4_5 = object : Migration(4, 5) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE messages ADD COLUMN is_scheduled INTEGER NOT NULL DEFAULT 0")
                db.execSQL("ALTER TABLE conversations ADD COLUMN is_scheduled INTEGER NOT NULL DEFAULT 0")
            }
        }
        ...
        private val MIGRATION_7_8 = object : Migration(7, 8) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("CREATE TABLE IF NOT EXISTS `recycle_bin_messages` (`id` INTEGER NOT NULL PRIMARY KEY, `deleted_ts` INTEGER NOT NULL)")
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(db: SupportSQLiteDatabase) {
                // The Gault Field Expansion: Adding is_p2p flag
                db.execSQL("ALTER TABLE recycle_bin_messages ADD COLUMN is_p2p INTEGER NOT NULL DEFAULT 0")
            }
        }
    }
}